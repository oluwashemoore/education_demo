...
namespace web_demo.Migrations
{
    ...
    [Migration("20201104074651_attendance-updates")]
    partial class attendanceupdates
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("web_demo.Entities.Attendance", b =>
                {
                    ...
                    b.HasIndex("AttendanceDetailsId");
            ...
            modelBuilder.Entity("web_demo.Entities.Attendance", b =>
                {
                    b.HasOne("web_demo.Entities.AttendanceDetails", "AttendanceDetails")
                        .WithMany()
                        .HasForeignKey("AttendanceDetailsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
